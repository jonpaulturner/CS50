...
function addMarker(place)
{
    ...
    marker.addListener('click', function(){
        ...
        $.getJSON("/articles", parameters, function(articles, textStatus, jqXHR){
            //var contents = [];
            var contents = "";
                $.each(articles.slice(0,5),function(i,val){
                //contents.push("<li>"+"<a href= "+val.link+">"+val.title+"</a>"+"</li>");
                    contents+=("<li>"+"<a href= "+val.link+">"+val.title+"</a>"+"</li>");
                    })

        info.close(map,marker)
        info.setContent("<ul>" + contents + "</ul>");
